...
public class InputCalculatorFrame extends javax.swing.JFrame {
    ...
    String oldCat, newCat;
    int amount, newAmt, oldAmt;
    Date d;
    ...
    public InputCalculatorFrame() {
     ...
     /*public InputCalculatorFrame(String cCat, String cResult, String cDesc, Date cDate) {
        ...
        if(txnId!=null)
        {
           btnAddExpense.setText("UPDATE TRANSACTION");
    ...
    public InputCalculatorFrame(String cTxn, String cCat, String cResult, String cDesc, Date cDate) {
        ...
        if(txnId!=null)
        {
           btnAddExpense.setText("UPDATE TRANSACTION");
           //oldCat = cCat;
           //oldAmt = Integer.parseInt(cResult);
        }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Made some Expense?");
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGap(649, 649, Short.MAX_VALUE))
        );
    ...
    private void lblBackMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblBackMouseClicked
        ...
        if (txnId != null) {
            ...
            ExpenseHistoryFrame exp = new ExpenseHistoryFrame();
            exp.setVisible(true);
            this.dispose();
            return;
                ...
                if (DateChooser.getDate() != null) {
                    ...
                    try {
                        ...
                        if (txnId != null) {
                            ...
                            boolean upTx = updateTransaction();

                            newAmt = amount;
                            newCat = category;
                            boolean upCat = updateCategories();

                            if ((upTx) && (upCat)) {
                                JOptionPane.showMessageDialog(null, "Your Expenses have been updated succesfully", "Updation Successful", JOptionPane.INFORMATION_MESSAGE);
                                PersonalExpenseFrame pef = new PersonalExpenseFrame();
                                pef.setVisible(true);
                                this.dispose();
                                return;
                            }
                            JOptionPane.showMessageDialog(null, "Failed to Update your expenses", "Unsuccesful Updation", JOptionPane.ERROR_MESSAGE);
    ...
    private boolean updateTransaction() {
        boolean up = false;
        SelfHistory selfUpdate = new SelfHistory(uid, txnId, amount, d, category, descript);
        try {
            up = SelfHistoryDAO.updateSelfTx(selfUpdate);
    ...
    private boolean updateCategories() {
        boolean remCat = false, addCat = false;
        try {
            remCat = CategoriesDAO.removeOldCatwise(uid, GlobalData.getOldCat(), GlobalData.getOldAmt());
            System.out.println(remCat);
            addCat = CategoriesDAO.addNewCatwise(uid, newCat, newAmt);
